...
export default function ChakraTable() {
  ...
  const getmerch = async () => {
    ...
    myheaders.append("Content-Type", "application/json");
    const url = `https://api.paybaba.co/admin/getAllMerchants?admin_jwt=${jwt_token}`;
    var requestOptions = {
      method: "GET",
      headers: myheaders,
    };
  ...
  const getStatusData = async (e, status) => {
    ...
    myheaders.append("Content-Type", "application/json");
    const url = `https://api.paybaba.co/admin/getbystatus?admin_jwt=${jwt_token}&status=${status}`;
    var requestOptions = {
      method: "GET",
      headers: myheaders,
    };
  ...
  const getMerchTrans = async (e, id) => {
    ...
    myheaders.append("Content-Type", "application/json");
    const url = `https://api.paybaba.co/admin/getMerchantTrans?admin_jwt=${jwt_token}&merchantid=${id}`;
    var requestOptions = {
      method: "GET",
      headers: myheaders,
    };
